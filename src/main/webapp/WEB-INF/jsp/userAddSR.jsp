...
<head>
    ...
    <script language=javascript>
        function addnum(){
            ...
            var cost=document.all("total_cost_s");
            if(obj.value=="" || isNaN(obj.value))return false;
            obj.value ++;
            cost.value=50* obj.value;
        }
        function minus(){
            var obj=document.all("reserv_num");
            var cost=document.all("total_cost_s");
...
<div class="book-main">
    <div class="right-module">
        <form action="${pageContext.request.contextPath}/sys/user/addSR.html" method="post"
              enctype="multipart/form-data">
            <input type="hidden" name="user_id" id="user_id" value="${userSession.user_id }">
            <input type="hidden" name="scenery_id" id="scenery_id" value="${scenerySession.scenery_id }">
            <input type="hidden" name="scenery_name" id="scenery_name" value="${scenerySession.scenery_name }">

            <div class="addHR">
                <p><span class="HR-title">门票信息</span></p>

                <label class="HR-text">预订时间</label>
                <div class="hotel-time">
                    <input type="Date" name="Sdate" id="Sdate" placeholder="预订时间">
                </div>
                <div class="roomnum">
                    <label class="HR-text">预订张数</label>
                ...
                <div class="room_cost" style="padding-left: 15px">
                    <input name="total_cost_s" id="total_cost_s" size="4" value="0"> <label > ¥</label>
                </div>
    ...
    <div class="left-module">
        <div class="hotel-HR-left">
            <div class="HR-img">
                <img src="${pageContext.request.contextPath }/statics/images/${scenerySession.scenery_cover}" style="width: 100%;height: 250px">
            </div>
            <div class="info-HR">
                <div class="HR-hotel-name">
                    <span class="HR-title">${scenerySession.scenery_name }</span>
                </div>
                <div class="HR-hotel-addr">
                    <p>${scenerySession.scenery_address }</p>
                </div>
            </div>
