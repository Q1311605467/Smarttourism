    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group">
                <a href=""  class="list-group-item active">酒店房间管理</a>
<%--                <a href="" role="button"  class="list-group-item" data-toggle="modal" data-target="#myModal">添加房间信息</a>--%>
            </div>
        </div>
        <div class="col-md-10">
            ...
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="" onclick="hotelRoom(${hotel_id})">酒店房间编辑</a>
                </li>
            </ul>
            <form  action="${pageContext.request.contextPath}/sys/updateRoom" class ="form1" method="post" enctype="multipart/form-data">
                <input type="hidden" id="hotel_id" name ="hotel_id" class="form-control" value="${hotel_id}">
                <input type="hidden" id="room_id" name ="room_id" class="form-control" value="${hotel_room.room_id}">
                <div class="form-group">
                    <label >房间类型</label>
                    <input type="text" id="room_type" name ="room_type" class="form-control" placeholder="请插入房间类型"  value="${hotel_room.room_type}" required="required">
                </div>
                <div class="form-group">
                    <label >房间价格</label>
                    <input type="text" id="cost" name ="cost" class="form-control" placeholder="请输入房间价格" value="${hotel_room.cost}" required="required" onkeyup="javascript:CheckInputIntFloat(this);"/><span style="color: red;">
                    <%--                        <input  type="number" id="cost" name ="cost" class="form-control" placeholder="请输入房间价格"  required="required">--%>
                </div>
