    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="sceneryList.html">预订信息记录</a>
                </li>
            </ul>
            <table class="table">
                <thead>
                <tr>
                    <th width="10%">预订编号</th>
<%--                    <th width="10%">预约用户编号</th>--%>
                    <th width="20%">景区名字</th>
                    <th width="20%">预订日期</th>
                    <th width="10%">预订数量</th>
                    <th width="20%">预约用户电话</th>
                    <th width="10%">总门票价格</th>
<%--                    <th width="5%">操作</th>--%>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${scenery_reservations}" var="reservation">
                    <tr id="${reservation.scen_reserv_id}">
                        <td scope="row">${reservation.scen_reserv_id}</td>
<%--                        <td>${reservation.user_id}</td>--%>
                        <td>${reservation.scenery_name}</td>
                        <td>${reservation.date}</td>
                        <td>${reservation.reserv_num}</td>
                        <td>${reservation.tel}</td>
                        <td>${reservation.total_cost_s}</td>
<%--                        <td>--%>
