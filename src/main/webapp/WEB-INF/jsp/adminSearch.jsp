...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <form action="${pageContext.request.contextPath}/sys/adminSearchByName" class="admin_search" method="get">
                ...
                <div class="form-group">
                    ...
                    <input type="texte" id="admin_account" name = "admin_account" class="form-control" placeholder="请输入管理员名">
                </div>
                <!--                 函数处理 -->
