    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group">
                <a href="sceneryList.html" class="list-group-item ">景区管理</a>
                <a href="scenerySerach.html" class="list-group-item active">景区搜索</a>
        ...
        <div class="col-md-10">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="active">
                    <a href="scenerySerach.html">景区搜索</a>
                </li>
                <li>
                    <a href="" role="button" data-toggle="modal" data-target="#myModal">添加景区信息</a>
                </li>
            </ul>
            <form action="${pageContext.request.contextPath}/sys/scenerySearch" class="user_search" method="get">
                ...
                <div class="form-group">
                    <label for="">用户名</label>
                    <input type="text" id="rest_name1" name = "scenery_name1" class="form-control" placeholder="请输入景区名">
                </div>
                <!--                 函数处理 -->
