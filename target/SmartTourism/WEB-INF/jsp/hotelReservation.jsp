    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="hotelReservation.html">酒店预约记录</a>
                </li>
<%--                <li>--%>
...
<%--                </li>--%>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <th width="10%">房间类型</th>
                    <th width="10%">预约间数</th>
                    <th width="10%">是否有早餐</th>
                    <th width="10%">用户电话</th>
                    <th width="10%">总金额</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${HRList}" var="reserv">
                    <tr id="${reserv.reserv_id}">
                        <td scope="row">${reserv.reserv_id}</td>
                        <td>${reserv.hotel_name}</td>
                        <td>${reserv.in_time}</td>
                        <td>${reserv.out_time}</td>
                        <td>${reserv.room_type}</td>
                        <td>${reserv.reserv_num}</td>
                        <td>${reserv.is_breakfast}</td>
                        <td>${reserv.tel}</td>
                        <td>${reserv.total_cost}</td>
