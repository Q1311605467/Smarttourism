    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group">
                <a href="strategyUnreviewedList.html" class="list-group-item active">推文管理</a>
                <a href="strategyReviewedList.html" class="list-group-item">通过的推文</a>
        ...
        <div class="col-md-10">
            ...
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="strategyUnreviewedList.html">推文未审核列表</a>
                </li>
                <li  >
                        ...
                        <td>
                            <div role="presentation" class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="${pageContext.request.contextPath }/sys/StrategyDetail2/${strategy.strategy_id}">查看详情</a>
                                    </li>
<%--                                    <li><a id="passStrategy" onclick="passStrategy(${strategy.strategy_id})">审核通过</a></li>--%>
<%--                                    <li><a id="unPassStrategy" onclick="unPassStrategy(${strategy.strategy_id})">审核不通过</a></li>--%>
