    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group">
                ...
                <a href="hotelSerach.html" class="list-group-item active">酒店搜索</a>
        ...
        <div class="col-md-10">
            ...
            <form action="${pageContext.request.contextPath}/sys/hotelSearch" class="user_search" method="get">
                <div class="alert alert-info" role="alert">
                    <strong>技巧提示：</strong>
                    支持模糊搜索和匹配搜索
                </div>
                <div class="form-group">
                    <label for="">酒店名字</label>
                    <input type="text" id="hotel_name1" name = "hotel_name1" class="form-control" placeholder="请输入用户名">
                </div>
                <!--                 函数处理 -->
