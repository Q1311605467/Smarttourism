...
<div style="margin-left: 20%; margin-right: 20%; margin-top: 5%" id="myModal">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">更新攻略</h4>
        </div>

        <div class="modal-body">
            <form action="${pageContext.request.contextPath}/sys/user/updateStrategyBID.html" method="post"
                ...
                <div class="form-group">
                    <label for="strategy_cover">更改攻略封面</label><br>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" cols="100" rows="8" id="content" required="required"
                              style="width: 100%; height: 100%;">${Strategy.content}</textarea>
                </div>
